CREATE DATABASE IF NOT EXISTS monitoramento_climatico;
USE monitoramento_climatico;
...
CREATE TABLE incidentes (
    ...
    FOREIGN KEY (id_tipo) REFERENCES tipos_incidentes(id_tipo) ON DELETE CASCADE,
    FOREIGN KEY (id_severidade) REFERENCES severidades(id_severidade) ON DELETE CASCADE
);
